...
DATABASE_URL = (
    "postgresql://neondb_owner:npg_hmrFcXjY4bi3@ep-restless-block-b4evikqf-pooler.c-6.us-east-2.aws.neon.tech/earthquakes?sslmode=require&channel_binding=require"
)
